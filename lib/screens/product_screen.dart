...
class _ProductScreenState extends State<ProductScreen> {
  Expanded boxSpacing = Expanded(child: Container());
  @override
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            constraints: BoxConstraints(
                                maxHeight: screenSize.height / 3.3),
                        ...
                        CustomMainButton(
                          ...
                          isLoading: false,
                          onPressed: (() async {
                            await CloudFirestoreMethods().addProductsToOrders(
